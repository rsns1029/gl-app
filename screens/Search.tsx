...
//     props.isDarkMode === 'light' ? '#F0F0F0' : '#181818'};
...
//   const [
//     searchPhotosLazyQuery,
//     {data: searchPhotosData, loading: searchPhotosLoading, refetch},
...
//         </SearchingContainer>
//       )}
//       {searchPhotosLoading === false &&
//         searchPhotosData?.searchPhotos.photos?.length === 0 && (
//           <SearchingText>{keyword}키워드의 사진이 없습니다.</SearchingText>
//         )}
//       {searchPhotosLoading === false &&
//         searchPhotosData?.searchPhotos.photos &&
//         searchPhotosData?.searchPhotos.photos?.length > 0 && (
//           <FlatListContainer
//             numColumns={3}
